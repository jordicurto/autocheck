...
public class DateUtils {
	...
	public static void main(String args[]) {
		...
		for (Date d : getDateIntervals(calS.getTime(), calE.getTime(), DAY_INTERVAL_TYPE)) {
			System.out.println(format.format(d));
		}
		
		System.out.println("WEEK_INTERVAL");
		for (Date d : getDateIntervals(calS.getTime(), calE.getTime(), WEEK_INTERVAL_TYPE)) {
			System.out.println(format.format(d));
		}
		
		System.out.println("MONTH_INTERVAL");
		for (Date d : getDateIntervals(calS.getTime(), calE.getTime(), MONTH_INTERVAL_TYPE)) {
			System.out.println(format.format(d));
		}
	}
}
